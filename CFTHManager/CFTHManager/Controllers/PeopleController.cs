...
namespace CFTHManager.Controllers
{
	public class PeopleController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,FirstName,LastName,PhoneNumber,EmailAddress")] Person person)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,FirstName,LastName,PhoneNumber,EmailAddress")] Person person)
        {
            if (ModelState.IsValid)
            {
